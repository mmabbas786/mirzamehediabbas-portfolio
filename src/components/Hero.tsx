...
const Hero = () => {
  return <section className="relative min-h-screen flex items-center pt-32 overflow-hidden" style={{
    cursor: 'default'
  }}>
      {/* Background gradient */}
        ...
        <div className="flex flex-col justify-center md:pr-8">
          <div className="space-y-6 max-w-xl">
            ...
            animationDelay: '0.6s'
              ...
              <Link to="/projects" className="inline-flex items-center gap-2 px-6 py-3 rounded-lg bg-gradient-to-r from-mirzaPurple-500 to-mirzaPurple-600 text-white font-medium hover:shadow-lg hover:from-mirzaPurple-600 hover:to-mirzaPurple-700 transition-all duration-300 hover:scale-105" style={{
              cursor: 'pointer'
            }}>
                View Mobile Apps <ArrowRight size={18} />
              </Link>
              
              <Link to="/contact" className="inline-flex items-center gap-2 px-6 py-3 rounded-lg glass-effect text-white font-medium hover:bg-white/10 transition-all duration-300 hover:scale-105" style={{
              cursor: 'pointer'
            }}>
                Contact Me
              </Link>
          ...
          animationDelay: '0.8s'
            ...
            <div className="flex flex-col items-center p-3 glass-effect rounded-lg hover:bg-white/10 transition-all duration-300 hover:scale-105" style={{
            cursor: 'pointer'
          }}>
            ...
            cursor: 'pointer'
              ...
              <span className="text-sm text-white/80 text-center">Clean Code</span>
            </div>
            <div className="flex flex-col items-center p-3 glass-effect rounded-lg hover:bg-white/10 transition-all duration-300 hover:scale-105" style={{
            cursor: 'pointer'
          }}>
        ...
        <div className="flex items-center justify-center relative md:justify-end">
          ...
          <div className="relative animate-float">
            ...
            <div className="w-60 h-[480px] rounded-[40px] border-8 border-black bg-white overflow-hidden shadow-2xl relative">
              {/* iPhone notch */}
              <div className="absolute top-0 left-0 w-full h-6 bg-black z-10 flex justify-center items-center">
                <div className="w-1/3 h-4 bg-black rounded-b-xl"></div>
              </div>
              <img src="/lovable-uploads/f1b8ad0c-dfc1-47e6-a8ee-c671bc0ea2ad.png" alt="App Preview" className="w-full h-full object-cover" />
            </div>
            ...
            animationDuration: '7s'
              ...
              <div className="w-52 h-[420px] rounded-[40px] border-8 border-black bg-white overflow-hidden shadow-2xl transform -rotate-6 relative">
                ...
                <img src="/lovable-uploads/9bf63242-4052-460e-81aa-92ca6cb88854.png" alt="App Preview" className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
        </div>
