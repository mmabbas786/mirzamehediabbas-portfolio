  ...
  const socialLinks = [
    {
      icon: <Github size={20} />,
      name: "GitHub",
      link: "https://github.com/mmabbas786",
    },
    {
      icon: <Linkedin size={20} />,
      name: "LinkedIn",
      link: "https://www.linkedin.com/in/mirzamehediabbas/",
    },
    {
      icon: <Instagram size={20} />,
      name: "Instagram",
      link: "https://www.instagram.com/mirza.codes/",
    },
  ];
    ...
    <Fragment>
      ...
      <main className="pt-28 pb-24 relative">
        ...
        <div className="container px-6 mx-auto relative z-10">
          ...
          <div
            className="grid md:grid-cols-2 gap-10 items-start animate-fade-in-up"
            ...
            <div className="space-y-10">
              <div className="space-y-4">
                ...
                <p className="text-white/70">
                  ...
                  I'm always open to discussing new mobile app projects,
